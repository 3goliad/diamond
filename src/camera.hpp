...
glm::mat4 camera::view() { return glm::lookAt(pos, pos + dir_front, dir_up); }

// GLFW requires that the key callback take the scancode and mode, but we don't
// use them here
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wunused-variable"
void camera::key_callback(
        GLFWwindow* window, int key, int scancode, int action, int mode) {
