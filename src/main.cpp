...
void draw() {
  ...
  // glUniform1i(glGetUniformLocation(default_program.program, "gen_texture"),
  // 0);
  ...
  GLint proj_uniform =
      glGetUniformLocation(default_program.program, "projection");
...
class tile {
  ...
  void render_init() {
    ...
    glBindBuffer(GL_ARRAY_BUFFER, vertex_buffer);
    // Position attribute
    glVertexAttribPointer(attribute_index, num_components_in_attribute,
                          GL_FLOAT, GL_FALSE, stride, (GLvoid *)0);
